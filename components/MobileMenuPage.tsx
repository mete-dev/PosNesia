...
export const MOBILE_MENU_CATEGORIES: MenuCategory[] = [
    ...
    },
    {
        ...
        subItems: [
            ...
            { label: 'Tagihan Vendor', page: Page.VendorBillList, icon: <Ico d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /> },
            { label: 'Tagihan Pelanggan', page: Page.CustomerBillList, icon: <Ico d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /> },
    ...
    },
    {
        ...
        subItems: [
            ...
            { label: 'Pembelian', page: Page.PurchaseReport, icon: <Ico d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /> },
    ...
    },
    {
        ...
        subItems: [
            ...
            { label: 'Ukuran Report', page: Page.ReportSizesSettings, icon: <Ico d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z" /> },
        ],
    },
];
