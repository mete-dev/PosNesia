...
export const initialCompanyInfo: CompanyInfo = { name: 'Mete Corp', logoUrl: '/logo.png', address: 'Lumajang, Jawa Timur, Indonesia', email: 'support@posnesia.com', phone: '085852488293' };
